...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "security.rbac": "RBAC Scoped Tokens",
  "security.rateLimit": "Security Rate Limits",
  "security.sandbox": "Sandbox Permission Gates",
  monitoring: "Agent Monitoring",
  "monitoring.heartbeat": "Heartbeat Monitoring",
